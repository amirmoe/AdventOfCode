...
namespace AdventOfCode.Solutions
{
    ...
    abstract class ASolution
    {
        ...
        protected string DebugInput { get; set; }
        protected string Input => DebugInput ?? (string.IsNullOrEmpty(_input.Value) ? null : _input.Value);
        private string Part1 => string.IsNullOrEmpty(_part1.Value) ? "" : _part1.Value;
        private string Part2 => string.IsNullOrEmpty(_part2.Value) ? "" : _part2.Value;
        ...
        {
            var inputFilepath = Path.GetFullPath(Path.Combine(AppContext.BaseDirectory, $"../../../Solutions/Year{Year}/Day{Day.ToString("D2")}/input"));
